...
main = tkinter.Tk()
main.title("Deep Learning to Predict Plant Growth")
...
font = ('times', 16, 'bold')
title = Label(main, text='Using Deep Learning to Predict Plant Growth and Yield in Greenhouse Environments')
